...
# Build the images
docker build $(dirname $0)/cli $f -t digitpeak/dpdocker-cli:8.2 --build-arg PHP_VERSION=8.1
...
docker build $(dirname $0)/web $f -t digitpeak/dpdocker-web:8.2 --build-arg PHP_VERSION=8.1
