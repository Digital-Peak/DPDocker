...
docker build $(dirname $0)/cli $f -t digitpeak/dpdocker-cli:latest --build-arg PHP_VERSION=8.2
...
docker build $(dirname $0)/web $f -t digitpeak/dpdocker-web:latest --build-arg PHP_VERSION=8.2
