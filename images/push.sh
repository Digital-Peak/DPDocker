...
docker push digitpeak/dpdocker-cli:8.4
docker push digitpeak/dpdocker-cli:8.5
docker push digitpeak/dpdocker-cli:latest
docker push digitpeak/dpdocker-web:8.2
docker push digitpeak/dpdocker-web:8.3
docker push digitpeak/dpdocker-web:8.4
docker push digitpeak/dpdocker-web:8.5
